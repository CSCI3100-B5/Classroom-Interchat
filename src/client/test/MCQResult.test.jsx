...
import MCQResult from '../classroom/session/chatbox/message/quiz/MCQPrompt.jsx';
...
describe('MCQResult Component', function () {
  ...
  beforeEach(function () {
    ...
    MCQResult.__Rewire__('useRealtime', function useRealtime() {
      return { ansMCQuiz: fakeAnsMCQuiz };
    });
    MCQResult.__Rewire__('useDataStore', function useDataStore() {
      return { data: fakeData };
    });
    MCQResult.__Rewire__('useToast', function useDataStore() {
      return { toast: fakeToast };
    });
    MCQResult.__Rewire__('TokenAwarder', function fakeTokenAwarder({ userIds }) {
  ...
  afterEach(function () {
    ...
    sinon.restore();
    MCQResult.__ResetDependency__('useRealtime');
    MCQResult.__ResetDependency__('useDataStore');
    MCQResult.__ResetDependency__('useToast');
    MCQResult.__ResetDependency__('TokenAwarder');
